...
def search_list(request):
    if request.method == 'GET':
        ...
        data = [{'id': search.id, 'sustainability_score': search.sustainability_score, 'airline_id': search.airline_id, 'origin_id': search.origin_id, 'destination_id': search.destination_id, 'flight_duration': search.flight_duration} for search in searches]
        ...
        return JsonResponse({'id': search.id, 'sustainability_score': search.sustainability_score, 'airline_id': search.airline_id, 'origin_id': search.origin_id, 'destination_id': search.destination_id, 'flight_duration': search.flight_duration})
...
def search_detail(request, pk):
    ...
    if request.method == 'GET':
        data = {'id': search.id, 'sustainability_score': search.sustainability_score, 'airline_id': search.airline_id, 'origin_id': search.origin_id, 'destination_id': search.destination_id, 'flight_duration': search.flight_duration}
        return JsonResponse(data)
    
    elif request.method == 'PUT':
        search.sustainability_score = request.POST.get('sustainability_score')
        search.airline_id = request.POST.get('airline_id')
